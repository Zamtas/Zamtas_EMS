  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        const { token, role, username } = response.data.data; // Extract username from the response
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 py-6 sm:py-12">
      <div className="text-center mb-8 px-4">
        <h1 className="text-3xl sm:text-4xl font-bold text-blue-700">
          Welcome to Zamtas-EMS
        </h1>
        <p className="text-lg sm:text-2xl text-gray-900 mt-2">
